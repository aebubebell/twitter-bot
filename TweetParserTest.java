...
public class TweetParserTest {
    ...
    @Test
    public void testExtractColumnull() {
        String string = TweetParser.extractColumn(null, 0);
        assertNull(string);
    }
    
    @Test
    public void testExtractcolumnOoB() {
        
        boolean bool = false;
        try {
            String string = TweetParser.extractColumn("CIS, 120, 160", 5);
    ...
    @Test
    public void testCSVFile2tweets() {
        boolean bool = false;
        try {
            List<String> indice = TweetParser.csvFileToTweets(null, 0);
    ...
    @Test
    public void testCSVFile2tweets2ndTest() {
        boolean bool = false;
        try {
            List<String> indice = TweetParser.csvFileToTweets("", 0);
    ...
    @Test
    public void testCVSFile2TrainingDataIllArg() {
        boolean bool = false;
        try {
            List<List<String>> indice = TweetParser.csvFileToTrainingData(null, 0);
        } catch (NullPointerException e) {
            bool = true;
            assertTrue(true);
        }
    ...
    @Test
    public void testCVSFile2TrainingDataIllArg2nd() {
        boolean bool = false;
        try {
            List<List<String>> indice = TweetParser.csvFileToTrainingData("", 0);
        } catch (IllegalArgumentException e) {
            bool = true;
            assertTrue(true);
        }
